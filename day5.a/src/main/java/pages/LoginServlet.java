	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try(PrintWriter pw=response.getWriter())
		{
			...
			if(customer == null) {
				...
				System.out.println("Imple class name "+session.getClass().getName());
				...
				//create empty art and add it under seesion scope
				session.setAttribute("shoppin_cart", new ArrayList<Integer>());
				...
				//SC 302 | location=category,set-cookie : JSESSIONID : dgafdgdf65764868  | body EMPTY
